...
import { testReactVersion } from './version';
import { isFunctionLikeExpression, unwrapTSAsExpression, isAssignmentLHS, getKeyValue } from './ast';
...
export default function usedPropTypesInstructions(context, components, utils) {
