...
import { findReturnStatement, isFunctionLikeExpression } from './ast';
import propTypesUtil from './propTypes';
import { isJSX } from './jsx';
import usedPropTypesUtil from './usedPropTypes';
import defaultPropsUtil from './defaultProps';
...
function componentRule(rule, context) {
  ...
  const utils = {
    ...
    isExplicitComponent(node) {
      ...
      const commentAst = parse(comment.value, {
        unwrap: true,
